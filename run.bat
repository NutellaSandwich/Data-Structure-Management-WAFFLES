...
:RUNMAIN
    ...
    ECHO.
    java -cp "%projectRoot%\%buildFolder%\classes;%projectRoot%\lib\commons-io-2.6.jar;%projectRoot%\lib\cs126-interfaces-1.2.6.jar;%projectRoot%\lib\cs126-models-1.2.6.jar;" %mainClass%
    ECHO.
GOTO EOF
...
:RUN
    ...
    ECHO.
    CMD /C java -Xmx1700m --add-opens=java.base/sun.net.www.protocol.jar=ALL-UNNAMED -XX:+IgnoreUnrecognizedVMOptions -jar "%projectRoot%\%buildFolder%\waffles-current-build-port-%portNo%.jar" --server.port=%portNo%
GOTO EOF
